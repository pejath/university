...
(1..Student.count).each {
  |i|
  100.times {
    Mark.create(subject_id: rand(1..Subject.count), mark: rand(1..5), student_id: i, lecturer_id: rand(1..Lecturer.count), created_at: rand((DateTime.now - 1.month)..DateTime.now))
  }
}
